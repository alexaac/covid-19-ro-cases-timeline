...
let svg, sources, casesData, cases, simulation, idToNode;
...
const drawGraph = () => {
    ...
    // Set object for timeline
    timeLineGraph = new TimeLineGraph(".zoomable-group", graph, cases, idToNode);
